...
parser.add_argument('--ckpt', default='MEGA',
...
if args.dataset != 'none':
    ...
    args.train_file = os.path.join(root_path, 'benchmark', args.dataset,'txt/input_prepare_20_addd.json')
    args.val_file = os.path.join(root_path, 'benchmark', args.dataset,'txt/sorted_prepare.json'.format(args.dataset))
    args.test_file = os.path.join(root_path, 'benchmark', args.dataset,'txt/{}_test.txt'.format(args.dataset))
    args.pic_train_file = os.path.join(root_path, 'benchmark', args.dataset, 'imgSG/train2017')
    args.pic_val_file = os.path.join(root_path, 'benchmark', args.dataset, 'imgSG/train2017')
    args.pic_test_file = os.path.join(root_path, 'benchmark', args.dataset, 'imgSG/test')
    args.rel_train_file = os.path.join(root_path, 'benchmark', args.dataset,'rel_1/train20')
    args.rel_val_file = os.path.join(root_path, 'benchmark', args.dataset, 'rel_1/val_hard').format(args.rel_num)
